...
GitHub Actions treats compiler warnings as errors, checks that every maintained
source is reachable from `ClassFieldTheory.All`, audits all declarations for
